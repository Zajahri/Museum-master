    ...
    <div class="px-8 py-6 mt-4 text-left bg-white rounded-lg shadow-lg">
      <div class="flex items-center justify-center mb-12" >
        ...
        <form>
            ...
            <input 
              class="w-full rounded-lg py-2 px-3 bg-gray-100 text-gray-500 outline-none  hover:bg-gray-200 focus:bg-gray-200 mb-8" type="password" id="password" name="password"
            />
